...
# ---------------------------
# Generate Lorenz data for a list of r and initial conditions
# ---------------------------
...
# ---------------------------
# Main data generation and normalization
# ---------------------------
...
# Downsample data
sampling_number = 5  # Downsample by taking every 5th timestep
...
torch.save(data_all, "lorenz_dataset_not_normalized.pth")

# ---------------------------
# Normalization (based on first 14 trajectories used for training)
# ---------------------------
selected_data = x_data[:, :14, :]  # Use only first 14 trajectories for normalization
selected_r = r_tensor[:14]
